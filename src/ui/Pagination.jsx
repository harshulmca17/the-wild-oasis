...
export default function Pagination({ count, pages, result }) {
  ...
  return (
    <StyledPagination>
      <P>
        Showing <span>{currentPage > 1 ? (currentPage - 1) * PAGE_SIZE : 1}</span> to{" "}
        <span>{(currentPage - 1) * PAGE_SIZE + result}</span> for <span>{count}</span>
      </P>
      <Buttons>
